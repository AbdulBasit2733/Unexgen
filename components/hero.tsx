...
import { ArrowRight, Sun, Snowflake, Gauge, ChevronLeft, ChevronRight } from 'lucide-react'
...
const slides = [
  {
    ...
    eyebrowIcon: Sun,
    heading: 'Empowering Sustainability Through Smart Cooling & Renewable Energy',
    subheading:
  ...
  {
    video: '/videos/4324108-uhd_3840_2160_24fps.mp4',
    eyebrow: 'Solar EPC & Thermal Energy Storage',
    eyebrowIcon: Gauge,
    heading: 'Integrated Solar EPC & Thermal Storage for Continuous Low-Cost Cooling',
    subheading:
    ...
    >
      ...
      <div className="relative z-20 mx-auto w-full max-w-7xl px-4 pt-28 pb-24 md:px-8">
            ...
            >
              <div className="max-w-2xl">
                ...
                <div className="mt-8 flex flex-col gap-3 sm:flex-row">
                  ...
                  >
                    <Link href="#contact" className='flex w-full h-full items-center gap-2'>
        ...
        <div className="invisible max-w-2xl">
          <span className="inline-flex items-center gap-2 px-4 py-1.5 text-xs">&nbsp;</span>
          <h1 className="mt-6 font-heading text-4xl sm:text-5xl lg:text-6xl">&nbsp;</h1>
